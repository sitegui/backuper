...
// config is an object with the keys "dumpFile", "timeBetweenCicles", "foldersPerStep", "timeBetweenSteps"
...
var _config // the config object (with keys "dumpFile", "timeBetweenCicles", "foldersPerStep", "timeBetweenSteps")
...
var runStep = function () {
    ...
    if (openedFolders)
        ...
        setTimeout(runStep, _config.timeBetweenCicles)
    }
}
